        ...
        <div className="w-full flex justify-start mt-4 items-center gap-4">
          ...
          <AlertDialog.Root>
            ...
            <AlertDialog.Content maxWidth="450px">
              ...
              <AlertDialog.Description size="2">
                Are you sure? If you delete this proposal, you will not be able to
                recover it.
          ...
          <Dialog.Root>
            ...
            <Dialog.Content maxWidth="450px">
              <Dialog.Title>Edit Proposal</Dialog.Title>
              <Dialog.Description size="2" mb="4">
                Edit Your Proposal Here.
              </Dialog.Description>
          ...
          <AlertDialog.Root>
            ...
            <AlertDialog.Content maxWidth="450px">
              <AlertDialog.Title>Completed Proposal</AlertDialog.Title>
              <AlertDialog.Description size="2">
